...
Usage:
    uv run python scripts/run_tracker.py --config configs/krovanh.yaml --case init-2026-08-31T18
"""
...
def main() -> None:
    ...
    raise NotImplementedError(f"TODO: run_tracker for case {case.id} (init {case.init_time})")
