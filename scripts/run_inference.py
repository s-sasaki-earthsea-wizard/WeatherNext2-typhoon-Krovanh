...
Usage:
    uv run python scripts/run_inference.py --config configs/krovanh.yaml --case init-2026-08-31T18
"""
...
def main() -> None:
    ...
    raise NotImplementedError(f"TODO: run_inference for case {case.id} (init {case.init_time})")
